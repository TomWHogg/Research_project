...
fig1 = px.violin(y= adata.uns['nhood_adata'].obs['logFC'], color= adata.uns['nhood_adata'].obs['nhood_annotation'])
...
# Plot the first volcano plot
volcano_plot(result_oligo, title='LogFC of Oligodendrocytes')

# Plot the second volcano plot
volcano_plot(result_astro, title='LogFC of Astrocytes')
